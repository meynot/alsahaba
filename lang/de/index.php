...
return [
    ...
    "An unexpected error occurred and we have notified our support team. Please try again later."=> "Es ist ein unerwarteter Fehler aufgetreten und wir haben unser Support-Team benachrichtigt. Bitte versuchen Sie es später noch einmal.",
    "Andorra"=> "Andorra",
    "Angola"=> "Angola",
    "Anguilla"=> "Anguilla",
    "Another user has updated this resource since this page was loaded. Please refresh the page and try again."=> "Ein anderer Benutzer hat diese Ressource aktualisiert, seit diese Seite geladen wurde. Bitte aktualisieren Sie die Seite und versuchen Sie es erneut.",
    ...
    "Are you sure you want to delete this resource?"=> "Sind Sie sicher, dass Sie diese Ressource löschen wollen?",
    ...
    "Are you sure you want to detach the selected resources?"=> "Sind Sie sicher, dass Sie die ausgewählten Ressourcen abtrennen wollen?",
    "Are you sure you want to detach this resource?"=> "Sind Sie sicher, dass Sie diese Ressource abtrennen wollen?",
    "Are you sure you want to force delete the selected resources?"=> "Sind Sie sicher, dass Sie das Löschen der ausgewählten Ressourcen erzwingen wollen?",
    "Are you sure you want to force delete this resource?"=> "Sind Sie sicher, dass Sie die Löschung dieser Ressource erzwingen wollen?",
    "Are you sure you want to log out?"=> "Sind Sie sicher, dass Sie sich abmelden möchten?",
    "Are you sure you want to restore the selected resources?"=> "Sind Sie sicher, dass Sie die ausgewählten Ressourcen wiederherstellen wollen?",
    "Are you sure you want to restore this resource?"=> "Sind Sie sicher, dass Sie diese Ressource wiederherstellen wollen?",
    "Are you sure you want to run this action?"=> "Sind Sie sicher, dass Sie diese Aktion ausführen wollen?",
    "Are you sure you want to stop impersonating?"=> "Sind Sie sicher, dass Sie das Imitieren stoppen wollen?",
    ...
    "China"=> "China",
    "Choose"=> "Wählen Sie",
    "Choose :field"=> "Wählen Sie :field",
    "Choose :resource"=> "Wählen Sie :resource",
    ...
    "Click to choose"=> "Klicken Sie zum Auswählen",
    "Close"=> "Schließen",
    ...
    "Confirm your :amount payment"=> "Bestätigen Sie Ihre :amount Zahlung",
    "Congo"=> "Kongo",
    ...
    "Djibouti"=> "Dschibuti",
    "Do you really want to leave? You have unsaved changes."=> "Wollen Sie wirklich gehen? Sie haben nicht gespeicherte Änderungen.",
    "Dominica"=> "Dominica",
    ...
    "If you need to add specific contact or tax information to your receipts, like your full business name, VAT identification number, or address of record, you may add it here."=> "Wenn Sie Ihren Quittungen bestimmte Kontakt- oder Steuerinformationen hinzufügen möchten, wie z. B. Ihren vollständigen Firmennamen, Ihre Umsatzsteuer-Identifikationsnummer oder Ihre Anschrift, können Sie diese hier hinzufügen.",
    ...
    "Login"=> "Anmelden",
    "Logout"=> "Abmelden",
    "Logout Other Browser Sessions"=> "Andere Browser-Sitzungen abmelden",
    "Logs"=> "Protokolle",
    ...
    "Manage and logout your active sessions on other browsers and devices."=> "Verwalten und Abmelden Ihrer aktiven Sitzungen in anderen Browsern und auf anderen Geräten.",
    ...
    "Our billing management portal allows you to conveniently manage your subscription plan, payment method, and download your recent invoices."=> "In unserem Portal zur Rechnungsverwaltung können Sie bequem Ihren Abonnementplan und Ihre Zahlungsmethode verwalten und Ihre letzten Rechnungen herunterladen.",
    ...
    "Please accept the terms of service."=> "Bitte akzeptieren Sie die Servicebedingungen.",
    ...
    "Please enter your password to confirm you would like to logout of your other browser sessions across all of your devices."=> "Bitte geben Sie Ihr Passwort ein, um zu bestätigen, dass Sie sich von Ihren anderen Browser-Sitzungen auf allen Ihren Geräten abmelden möchten.",
    "Please provide a maximum of three receipt emails addresses."=> "Bitte geben Sie maximal drei Beleg-E-Mail-Adressen an.",
    ...
    "Please provide the email address of the person you would like to add to this team. The email address must be associated with an existing account."=> "Bitte geben Sie die E-Mail-Adresse der Person an, die Sie diesem Team hinzufügen möchten. Die E-Mail-Adresse muss einem existierenden Account zugehörig sein.",
    ...
    "Search"=> "Suchen",
    "Select"=> "Wählen Sie",
    "Select a different plan"=> "Wählen Sie einen anderen Plan",
    "Select a log file..."=> "Protokolldatei auswählen...",
    ...
    "Sorry! You are not authorized to perform this action."=> "Entschuldigung! Sie sind nicht berechtigt, diese Aktion durchzuführen.",
    ...
    "The receipt emails must be valid email addresses."=> "Die Beleg-E-Mail-Adressen müssen gültige E-Mail-Adressen sein.",
    ...
    "This subscription cannot be resumed. Please create a new subscription."=> "Dieses Abonnement kann nicht fortgesetzt werden. Bitte legen Sie ein neues Abonnement an.",
    "This subscription has expired and cannot be resumed. Please create a new subscription."=> "Dieses Abonnement ist abgelaufen und kann nicht wiederaufgenommen werden. Bitte legen Sie ein neues Abonnement an.",
    ...
    "Two factor authentication is now enabled. Scan the following QR code using your phone's authenticator application."=> "Die Zwei-Faktor-Authentifizierung ist jetzt aktiviert. Scannen Sie den folgenden QR-Code mit der Authentifizierungsanwendung Ihres Smartphones.",
    "Type"=> "Type",
    "Uganda"=> "Uganda",
    "Ukraine"=> "Ukraine",
    ...
    "We are unable to process your payment. Please contact customer support."=> "Wir können Ihre Zahlung nicht bearbeiten. Bitte kontaktieren Sie den Kundensupport.",
    "We have emailed your password reset link!"=> "Wir haben Ihnen den Link zum Zurücksetzen Ihres Passworts per E-Mail zugeschickt!",
    ...
    "We will send a receipt download link to the email addresses that you specify below. You may separate multiple email addresses using commas."=> "Wir senden Ihnen einen Download-Link für den Beleg an die von Ihnen angegebenen E-Mail-Adressen. Sie können mehrere E-Mail-Adressen durch Kommata trennen.",
    "We're lost in space. The page you were trying to view does not exist."=> "Wir sind im Weltraum verloren. Die Seite, die Sie aufrufen wollten, existiert nicht.",
    ...
    "Yemen"=> "Jemen",
    "Yes"=> "Ja",
    "You are already subscribed."=> "Sie sind bereits angemeldet.",
    "You are currently within your free trial period. Your trial will expire on :date."=> "Sie befinden sich derzeit in Ihrem kostenlosen Testzeitraum. Ihre Testphase läuft am :date ab.",
    ...
    "Your :invoiceName invoice is now available!"=> "Ihre :invoiceName Rechnung ist jetzt verfügbar!",
    "Your card was declined. Please contact your card issuer for more information."=> "Ihre Karte wurde abgelehnt. Bitte kontaktieren Sie Ihren Kartenaussteller für weitere Informationen.",
    "Your current payment method is :paypal."=> "Ihre aktuelle Zahlungsmethode ist :paypal.",
    "Your current payment method is a credit card ending in :lastFour that expires on :expiration."=> "Ihre aktuelle Zahlungsmethode ist eine Kreditkarte mit der Endung :lastFour, die am :expiration ausläuft.",
